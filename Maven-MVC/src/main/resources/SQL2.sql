...
insert  into `system_permission`(`ID`,`PERMISSION_NAME`,`PID`,`TYPE`,`STATUS`,`URL`,`ICON`,`SORT`,`DESCRIPTION`) values ('5afba975-57cc-4bb1-8a01-bedc44a6d72b','system:manager',NULL,0,0,'/user/addmin',NULL,1,'用户');
...
insert  into `system_role_permission`(`ID`,`SYSTEM_ROLE_ID`,`PERMISSION_ID`) values ('da71f245-74cf-42c2-9c83-54e83289cd79','b1cdbaf6-6db2-488a-a5d4-dc401c609d20','5afba975-57cc-4bb1-8a01-bedc44a6d72b');
...
insert  into `system_user`(`ID`,`FIRST_NAME`,`LAST_NAME`,`USER_NAME`,`PASSWORD`,`EMAIL`,`ENABLED`,`CREATE_TIME`,`UPDATE_TIME`) values ('9f9d8b55-68c0-46a8-8f60-fa93c17b2bb6','何','壹轩','HeYixuan','123456','15517551511@126.com',0,'2016-06-29 17:10:53',NULL);
